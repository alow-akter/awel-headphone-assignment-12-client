...
const HeadphoneInfo = () => {
    return (
        <section>
            <div className="p-5 mx-auto sm:p-10 md:p-16 bg-[#FAFAFA] mt-4">
                <h3 className='text-4xl text-center text-[#FA826B]'>Experience the next level of silence.</h3>
                <hr className='w-[900px] mx-auto mt-4' />
                <div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded mt-10 font-semibold">
                    ...
                    <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-gray-900">
                        ...
                        <div className="space-y-2 bg-[#FFF1EF] p-4">
            ...
            <section className="py-6 sm:py-12 dark:bg-gray-800 dark:text-gray-100">
                <div className="container p-6 mx-auto space-y-8">
                    <div className="space-y-2 text-center">
                        <h2 className="text-3xl font-bold text-[#FA826B]">AWEI HEADPHONES</h2>
                    ...
                    <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <article className="flex flex-col dark:bg-gray-900">
                            <p>
                                <img alt="" className="object-cover w-full h-52 dark:bg-gray-500" src="https://dtboom.wpenginepowered.com/wp-content/uploads/2020/11/shop-7.jpg" />
                            </p>
                            <div className="flex flex-col flex-1 p-6">

                                <h3 className="flex-1 py-2 text-lg font-semibold leading-snug">Slick Earphone</h3>
                                <h3 className="flex-1 py-2 text-xs font-semibold leading-snug">There are many variations of lorem ipsum available, but the have suffered alteration in some form by humour.</h3>
                                <div className="flex flex-wrap justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
                                    <span>Price : $50</span>
